...
* If a user lost or wiped his phone he can log in using the recovery codes that he needs to download first by visiting /MODEL/recovery_codes (eg: /users/recovery_codes)
